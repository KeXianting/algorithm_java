...
public class TopK
{
    public static void main(String argv[]) throws IOException
    {
        ...
        List<Map.Entry<String, Integer>> wordList =  sorting(fmap);
    ...
    // SORTING METHOD/////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static List<Map.Entry<String, Integer>> sorting(Map<String, Integer> fmap)
    {
        Set<Map.Entry<String, Integer>> wordSet = fmap.entrySet();
    ...
    // DISPLAY METHOD/////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static void display(List<Map.Entry<String, Integer>> wordList, int tcount)
    {
        ...
        Map.Entry<String, Integer> max = wordList.get(0);
        System.out.println("-------------------------------------------------------------------------------------------");
