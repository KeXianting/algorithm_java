package methd_of_programing.big_data.trie;
...
/**
 * Created by kentorvalds on 2018/1/20.
 */
...
//            System.exit(1);
//        }
        String wordlistPath = "/Users/kentorvalds/Documents/JavaProject/JavaWeb/fromGITHUB/algorithm-job/src/methd_of_programing/big_data/trie/wordlist.txt";//args[0];
        assert !wordlistPath.isEmpty();
        WordsSearchTrie wordsSearchTrie = new WordsSearchTrie();
        wordsSearchTrie.loadTrie(wordlistPath);

        String word = "a?????o???s";//args[1];
        assert !word.isEmpty();
